                ...
                <div className='flex lg:flex-row flex-col items-center lg:pb-[170px] pb-25 '>
                    ...
                    >
                        <div className={`bg-primary xl:px-16 px-8 xl:pt-[78px] pt-10 xl:pb-[58px] pb-7  `}>
                            ...
                            <Link href={link}>
                                <ButtonFill className={"border-secondary text-primary-foreground hover:text-secondary-foreground after:left-0 after:bg-secondary"}>Ətraflı <RightArrow width={'35'} height={"22"} /></ButtonFill>
                            </Link>
                        </div>
                    </motion.div>
                </div>
