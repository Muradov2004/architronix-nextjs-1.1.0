            ...
            <div className='bottom-navbar flex justify-between items-center'>
                {/* <div>
                    <Link href="/" className={cn(`logo text-primary-foreground ${linkColor}`)}>
                        <Logo2 height={"31"} width={"219"} />
                    </Link>
                </div> */}

                <div>
                    <Link href="/home-1" className={cn(`logo text-primary-foreground ${linkColor}`)}>
                            ...
                            menuList.map(({ id, isDropdown, name, path, isMegaMenu }) => {
                                return (
                                    <li key={id} className='group'>
                                        <Link href={path} data-id={id} className={cn(`nav-link text-xl font-medium px-7 py-[36px] flex items-center   group-hover:bg-primary group-hover:text-secondary-foreground ${linkColor}`)}>
                                            {name}
                                            {
