        ...
        <>
            <section>
                <div className='container-fluid '>
                    <SectionTitle sectionName={"AZALI"} sectionTitle={"Bizimlə əlaqə"} sectionDesc={"Layihəniz üçün ideal həlli tapmağınıza kömək edəcəyik."} />
                </div>
            ...
            <section>
                <div className='container-fluid '>
                    <SectionTitle sectionName={"AZALI"} sectionTitle={"Fikirləriniz və ya təklifləriniz varmı?"} sectionDesc={"Bizə deyin və birlikdə həyata keçirək."} />
                </div>
                <div className='container lg:pt-30 2sm:pt-20 pt-14'>
